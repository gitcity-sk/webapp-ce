<header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top flex-md-nowrap p-0 bg-dark"
        ...
        <a class="navbar-brand ml-2" href="/">
            <span class="mr-2">
              <svg class="svg-inline--fa fa-cloud fa-w-20" aria-hidden="true" data-prefix="far" data-icon="cloud"
                   role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg=""><path
                          fill="currentColor"
        ...
        <div class="collapse navbar-collapse ml-2 mr-2" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/projects">@lang('messages.projects') <span
                                class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/groups">@lang('messages.groups') <span
                                class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
            ...
            <form class="form-inline mt-2 mt-md-0">
                ...
                @if (Route::has('login'))
                    @auth
                      ...
                      <span class="mr-2">
                        <svg class="svg-inline--fa fa-user-circle fa-w-16" aria-hidden="true" data-prefix="fal"
